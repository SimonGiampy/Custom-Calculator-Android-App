...
public class MaterialFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        getContext().setTheme(R.style.MaterialTheme);
    ...
    public void write_power(View view) {
        ...
        switch (button.getId()) {
            case R.id.mat_squared: power_pressed="2"; break;
            case R.id.mat_cubed: power_pressed="3"; break;
            case R.id.mat_power: power_pressed="x"; break;
            case R.id.mat_raised_to_minus1: power_pressed="−1"; break;
        }
    ...
    public void write_root(View view) {
        ...
        String txt = edit.getText().toString();
        String root_pressed = "√";
        if (view.getId() == R.id.mat_cubed_root) {
            root_pressed = "∛";
        }
    ...
    public void initializations(View view) {
        Button n0 = (Button) view.findViewById(R.id.mat_n0);
        Button n1 = (Button) view.findViewById(R.id.mat_n1);
        Button n2 = (Button) view.findViewById(R.id.mat_n2);
        Button n3 = (Button) view.findViewById(R.id.mat_n3);
        Button n4 = (Button) view.findViewById(R.id.mat_n4);
        Button n5 = (Button) view.findViewById(R.id.mat_n5);
        Button n6 = (Button) view.findViewById(R.id.mat_n6);
        Button n7 = (Button) view.findViewById(R.id.mat_n7);
        Button n8 = (Button) view.findViewById(R.id.mat_n8);
        Button n9 = (Button) view.findViewById(R.id.mat_n9);
        Button ac = (Button) view.findViewById(R.id.mat_ac);
        Button comma = (Button) view.findViewById(R.id.mat_comma);
        Button extra = (Button) view.findViewById(R.id.mat_extra);
        Button division = (Button) view.findViewById(R.id.mat_division);
        ImageButton backspace = (ImageButton) view.findViewById(R.id.mat_backspace);
        Button multiplier = (Button) view.findViewById(R.id.mat_multiplier);
        Button plus = (Button) view.findViewById(R.id.mat_plus);
        Button minus = (Button) view.findViewById(R.id.mat_minus);
        FloatingActionButton equal = (FloatingActionButton) view.findViewById(R.id.mat_equal);
        Button parenthesis = (Button) view.findViewById(R.id.mat_parenthesis);
        Button squared = (Button) view.findViewById(R.id.mat_squared);
        Button cubed = (Button) view.findViewById(R.id.mat_cubed);
        Button power = (Button) view.findViewById(R.id.mat_power);
        Button raised_to_minus1 = (Button) view.findViewById(R.id.mat_raised_to_minus1);
        Button root = (Button) view.findViewById(R.id.mat_root);
        Button cubed_root = (Button) view.findViewById(R.id.mat_cubed_root);
        Button random = (Button) view.findViewById(R.id.mat_random);
        Button factorial = (Button) view.findViewById(R.id.mat_factorial);
        Button sin = (Button) view.findViewById(R.id.mat_sin);
        Button cos = (Button) view.findViewById(R.id.mat_cos);
        Button tan = (Button) view.findViewById(R.id.mat_tan);
        Button e = (Button) view.findViewById(R.id.mat_e);
        Button sinh = (Button) view.findViewById(R.id.mat_sinh);
        Button cosh = (Button) view.findViewById(R.id.mat_cosh);
        Button tanh = (Button) view.findViewById(R.id.mat_tanh);
        Button log = (Button) view.findViewById(R.id.mat_log);
        Button pi = (Button) view.findViewById(R.id.mat_pi);
        Button ln = (Button) view.findViewById(R.id.mat_ln);
        Button exp = (Button) view.findViewById(R.id.mat_exp);
        Button ans = (Button) view.findViewById(R.id.mat_ans);
        edit = (TextView) view.findViewById(R.id.mat_edit);
        solution = (TextView) view.findViewById(R.id.mat_solution);
        ...
        if (isTheOrientationLandscape()) {
            RadioGroup radioGroup = (RadioGroup) view.findViewById(R.id.mat_radioGroup);
