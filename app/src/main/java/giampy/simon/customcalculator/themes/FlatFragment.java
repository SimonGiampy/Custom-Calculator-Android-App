...
public class FlatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        getContext().setTheme(R.style.FlatTheme);
    ...
    public void write_power(View view) {
        ...
        switch (button.getId()) {
            case R.id.flat_squared: power_pressed="2"; break;
            case R.id.flat_cubed: power_pressed="3"; break;
            case R.id.flat_power: power_pressed="x"; break;
            case R.id.flat_raised_to_minus1: power_pressed="−1"; break;
        }
    ...
    public void write_root(View view) {
        ...
        String txt = edit.getText().toString();
        String root_pressed = "√";
        if (view.getId() == R.id.flat_cubed_root) {
            root_pressed = "∛";
        }
    ...
    public void initializations(View view) {
        Button n0 = (Button) view.findViewById(R.id.flat_n0);
        Button n1 = (Button) view.findViewById(R.id.flat_n1);
        Button n2 = (Button) view.findViewById(R.id.flat_n2);
        Button n3 = (Button) view.findViewById(R.id.flat_n3);
        Button n4 = (Button) view.findViewById(R.id.flat_n4);
        Button n5 = (Button) view.findViewById(R.id.flat_n5);
        Button n6 = (Button) view.findViewById(R.id.flat_n6);
        Button n7 = (Button) view.findViewById(R.id.flat_n7);
        Button n8 = (Button) view.findViewById(R.id.flat_n8);
        Button n9 = (Button) view.findViewById(R.id.flat_n9);
        Button ac = (Button) view.findViewById(R.id.flat_ac);
        Button comma = (Button) view.findViewById(R.id.flat_comma);
        Button extra = (Button) view.findViewById(R.id.flat_extra);
        Button division = (Button) view.findViewById(R.id.flat_division);
        ImageButton backspace = (ImageButton) view.findViewById(R.id.flat_backspace);
        Button multiplier = (Button) view.findViewById(R.id.flat_multiplier);
        Button plus = (Button) view.findViewById(R.id.flat_plus);
        Button minus = (Button) view.findViewById(R.id.flat_minus);
        Button equal = (Button) view.findViewById(R.id.flat_equal);
        Button parenthesis = (Button) view.findViewById(R.id.flat_parenthesis);
        Button squared = (Button) view.findViewById(R.id.flat_squared);
        Button cubed = (Button) view.findViewById(R.id.flat_cubed);
        Button power = (Button) view.findViewById(R.id.flat_power);
        Button raised_to_minus1 = (Button) view.findViewById(R.id.flat_raised_to_minus1);
        Button root = (Button) view.findViewById(R.id.flat_root);
        Button cubed_root = (Button) view.findViewById(R.id.flat_cubed_root);
        Button random = (Button) view.findViewById(R.id.flat_random);
        Button factorial = (Button) view.findViewById(R.id.flat_factorial);
        Button sin = (Button) view.findViewById(R.id.flat_sin);
        Button cos = (Button) view.findViewById(R.id.flat_cos);
        Button tan = (Button) view.findViewById(R.id.flat_tan);
        Button e = (Button) view.findViewById(R.id.flat_e);
        Button sinh = (Button) view.findViewById(R.id.flat_sinh);
        Button cosh = (Button) view.findViewById(R.id.flat_cosh);
        Button tanh = (Button) view.findViewById(R.id.flat_tanh);
        Button log = (Button) view.findViewById(R.id.flat_log);
        Button pi = (Button) view.findViewById(R.id.flat_pi);
        Button ln = (Button) view.findViewById(R.id.flat_ln);
        Button exp = (Button) view.findViewById(R.id.flat_exp);
        Button ans = (Button) view.findViewById(R.id.flat_ans);
        edit = (TextView) view.findViewById(R.id.flat_edit);
        solution = (TextView) view.findViewById(R.id.flat_solution);
        ...
        if (isTheOrientationLandscape()) {
            RadioGroup radioGroup = (RadioGroup) view.findViewById(R.id.flat_radioGroup);
